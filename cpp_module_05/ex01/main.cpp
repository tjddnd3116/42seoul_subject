...
/*   Updated: 2022/04/23 13:18:17 by soum             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(void)
{
	...
	// john.signForm(&form7);  // john can sign form7
	// std::cout << form7 << std::endl;
    //
	// Form *form8 = new Form("form8", 41, 70);
	// std::cout << *form8 << std::endl;
	// john.signForm(form8);			// john grade is lower than form sign grade can't sign form8
	// std::cout << *form8 << std::endl;
    //
	// *form8 = form7;
    //
